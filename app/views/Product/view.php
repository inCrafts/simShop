        ...
        <div class="single-main">
            <div class="col-md-9 single-main-left">
                <div class="sngl-top">
                    ...
                    <?php
                        $curr = \simFW\App::$app->getProperty('currency');
                        $cats = \simFW\App::$app->getProperty('cats');
                    ?>
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <?php if ($product->old_price): ?>
                                <del><?= $curr['symbol_left']; ?><?= $product->old_price * $curr['value']; ?> <?= $curr['symbol_left']; ?></del>
                            <?php endif; ?>
                            <p><?= $product->content; ?></p>
                            <div class="available">
                                <ul>
                            ...
                            <ul class="tag-men">
                                <li><span>Category :</span>
                                    <a href="category/<?= $cats[$product->category_id]['alias']; ?>"><?= $cats[$product->category_id]['title']; ?></a></li>
                            </ul>
                            <div class="quantity">
                                ...
                                <div class="product-bottom">
                                    ...
                                    <h4>
                                        <?php if ($item['old_price']): ?>
                                            <del><?= $curr['symbol_left']; ?><?= $item['old_price'] * $curr['value']; ?> <?= $curr['symbol_left']; ?></del>
                                        <?php endif; ?>
                ...
                <?php if ($recentlyViewed): ?>
                    <div class="latestproducts">
                        <div class="product-one">
                            <h3>Выв недавно интересовались этими товарами:</h3>
